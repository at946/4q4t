feature "18_user_shows_a_member_card_randomly", type: :system, js: true do
  ...
  scenario "When the user clicks on 'start exercise' button on team page, the user moves to exercise page." do
    ...
    expect(page).to have_current_path drucker_exercise_path @team
  end
  ...
  scenario "When the user clicks on finish button on exercise page, the user moves to druckers page." do
    visit drucker_exercise_path @team
